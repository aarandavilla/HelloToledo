...
@NamedQueries({
    ...
    , @NamedQuery(name = "Contactos.findByContactoNombre", query = "SELECT c FROM Contactos c WHERE c.contactoNombre = :contactoNombre")
    , @NamedQuery(name = "Contactos.findByContactoApellido", query = "SELECT c FROM Contactos c WHERE c.contactoApellido = :contactoApellido")
